...
import { LuSwords, LuShield, LuZap } from 'react-icons/lu';
         ...
         {!inRoom ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
               <div className="glass-card p-12 hover:border-student-accent transition-colors">
                  <div className="text-5xl mb-6 text-student-accent/40 flex justify-center"><LuShield size={48} /></div>
               ...
               <div className="glass-card p-12 hover:border-student-accent transition-colors relative">
                  ...
                  <div className="text-5xl mb-6 text-student-accent/40 flex justify-center"><LuSwords size={48} /></div>
            ...
            <div className="glass-card p-12 max-w-2xl mx-auto mt-12 bg-black border-2 border-student-accent glow-red relative overflow-hidden">
               ...
               {countdown > 0 ? (
                  ...
                  >
                     <LuZap className="animate-pulse" /> Start Battle <LuZap className="animate-pulse" />
                  </button>
               )}
